...
* link:task-set-up-licensing-aws.html["在Cloud Volumes ONTAP Azure中設定for NetApp的授權"]
...
* link:task-set-up-licensing-aws.html["在Cloud Volumes ONTAP Google Cloud中設定適用於此技術的授權"]
